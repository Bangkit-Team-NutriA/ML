...
Original file is located at
    https://colab.research.google.com/drive/1ylSdR066ugxdO0JXTozTbCGeMM6Gu6EH
"""
...
model.fit(train_data_generator, validation_data=valid_data_generator, epochs=1,callbacks=[checkpoint, callbacks])

model.fit(train_data_generator, validation_data=valid_data_generator, epochs=2,callbacks=[checkpoint, callbacks])

with open('labels.json','w') as f:
  f.write(json.dumps(train_data_generator.class_indices,indent=4))